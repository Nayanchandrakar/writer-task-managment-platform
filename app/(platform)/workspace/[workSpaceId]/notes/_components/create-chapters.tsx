...
const CreateChapters: FC<CreateChaptersProps> = ({}) => {
  const createChapterModal = useCreateChapterModal();

  return (
    <div
      onClick={() => createChapterModal?.onOpen()}
      className="w-48 h-28 rounded-md text-xs bg-zinc-100 flex items-center justify-center relative transition-colors duration-200 hover:bg-zinc-200 cursor-pointer"
    >
